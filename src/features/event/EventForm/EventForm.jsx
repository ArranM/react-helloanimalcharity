...
class EventForm extends Component {
    ...
    render() {
        ...
        return (
            <Segment>
                <Form onSubmit={this.handleFromSubmit} autoComplete='off'>
                    <Form.Field>
                        <label>Event Title</label>
                        <input onChange={this.handleInputChange} name='title' value={title} placeholder="First Name" />
                    </Form.Field>
                    <Form.Field>
                    ...
                    <Form.Field>
                        ...
                        <input onChange={this.handleInputChange} name='hostedBy' value={hostedBy} placeholder="Enter the name of person hosting" />
                    </Form.Field>
